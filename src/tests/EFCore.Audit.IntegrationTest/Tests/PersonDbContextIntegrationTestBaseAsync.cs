...
{
    public abstract class PersonDbContextIntegrationTestBaseAsync : PersonDbContextTestBase
    {
        public PersonDbContextIntegrationTestBaseAsync(DbConnection connection, string migrationAssembly)
