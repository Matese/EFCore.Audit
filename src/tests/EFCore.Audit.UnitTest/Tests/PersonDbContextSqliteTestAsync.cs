...
using EFCore.Audit.TestCommon.Tests;
...
{
    public class PersonDbContextSqliteTestAsync : PersonDbContextTestBase
    {
        private static readonly object _lock = new();

        public PersonDbContextSqliteTestAsync() 
            : base(new SqliteConnection("Filename=:memory:"), null)
        {
        }
